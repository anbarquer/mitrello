...
<title>miTrello - Modificar lista</title>
</head>
...
<body>
	...
	<aside>
		<div id="cuerpo">
			<h1>Modificar lista</h1>
			<div id="error">
				<p>${error}</p>
			</div>
			<div id="formulario">
				<form method="post" action="modifica_lista">

					<p>
						<label for="nombre_lista">Nombre de la lista:<span
							class="required"></span></label>
					</p>
					<p>
						<input type="text" id="nombre_lista" name="nombre_lista" value=""
							placeholder="Nombre de la lista" required="required"
							autofocus="autofocus" />
					</p>
					<p>
						<input type="submit" value="Modificar lista" id="submit"
